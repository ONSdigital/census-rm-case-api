...
## Endpoints
The OpenAPI v3 spec can be found here: [openapi.json](api-docs/openapi.json)

The API is documented in human-readable format, here: [openapi.md](api-docs/openapi.md)
