...
public class UacQidEndpoint {
  ...
  public UacQidEndpoint(UacQidServiceClient uacQidServiceClient, UacQidDistributor uacQidDistributor) {
    this.uacQidServiceClient = uacQidServiceClient;
    this.uacQidDistributor = uacQidDistributor;
  }

  @PostMapping(path = "/create", consumes = "application/json", produces = "application/json")
  public ResponseEntity<UacQidCreatedDTO> createAndLinkUacQid(@RequestBody CaseDetailsDTO caseDetails) {
    ...
    UacQidCreatedDTO uacQidCreated = uacQidServiceClient.generateUacQid(questionnaireType);
    uacQidDistributor.sendUacQidCreatedEvent(uacQidCreated, caseDetails.getCaseId());
    return ResponseEntity.status(HttpStatus.CREATED).body(uacQidCreated);
  }
}
